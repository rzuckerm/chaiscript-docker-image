CHAISCRIPT_VERSION := $(shell cat CHAISCRIPT_VERSION)
CHAISCRIPT_DEPS := $(wildcard CHAISCRIPT_*)
DOCKER_TAG_PREFIX := rzuckerm/chaiscript:$(CHAISCRIPT_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(CHAISCRIPT_DEPS)
